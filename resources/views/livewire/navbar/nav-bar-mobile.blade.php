<div class="container-fluid">
    <!-- Toggler -->
    <button class="navbar-toggler" type="button" data-toggle="collapse" wire:click="openBar(1)" data-target="#sidebarCollapse" aria-controls="sidebarCollapse" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <!-- Collapse -->
    <div class="collapse navbar-collapse @if($this->menuBar == 1)show @endif" id="sidebarCollapseMobile">
        <!-- Navigation -->
        <ul class="navbar-nav">
            <li class="nav-item">
